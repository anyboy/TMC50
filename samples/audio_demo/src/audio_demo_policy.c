...
static struct audio_policy_t system_audio_policy = {
...
#elif CONFIG_AUDIO_OUT_SPDIFTX_SUPPORT
	...
	.audio_in_mic_gain = 330, // 33db
	.audio_in_adc_gain = 0,// 0db

	.voice_aec_tail_length_16k = 48,
	.voice_aec_tail_length_8k = 96,
...
extern void system_audio_policy_init(int aout_channel_type)
{
	...
	printk("----------audio_policy_register aout_channel_type: %d\n", aout_channel_type);

	system_audio_policy.audio_out_channel = aout_channel_type;

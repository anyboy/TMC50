...
#ifndef __INCLUDE_MIPS32_CP0__
#define __INCLUDE_MIPS32_CP0__
...
/* status */
#ifdef CONFIG_USE_MIPS16E
extern __attribute__((nomips16)) unsigned int mips32_getcount(void);

extern __attribute__((nomips16)) unsigned int mips32_getstatus(void);
extern __attribute__((nomips16)) void mips32_setstatus(unsigned int val);

extern __attribute__((nomips16)) unsigned int mips32_getcause(void);
extern __attribute__((nomips16)) void mips32_setstatus(unsigned int val);

#else
/* count */
#define mips32_getcount()	_mips_mfc0(9)

/* status */
#define mips32_getstatus()	_mips_mfc0(12)
#define mips32_setstatus(v)	_mips_mtc0(12,v)

/* cause */
#define mips32_getcause()	_mips_mfc0(13)
#define mips32_setcause(v)	_mips_mtc0(13,v)

...
enum MIPS6e_i8_func {
	...
	MIPS16e_adjsp_func = 03,
	MIPS16e_svrs_func = 04,
 ...
 */
struct m16e_rr {
	BITFIELD_FIELD(unsigned short opcode : 5,
	BITFIELD_FIELD(unsigned short rx : 3,
	BITFIELD_FIELD(unsigned short nd : 1,
	BITFIELD_FIELD(unsigned short l : 1,
	BITFIELD_FIELD(unsigned short ra : 1,
	BITFIELD_FIELD(unsigned short func : 5,
	;))))))
};

struct m16e_jal {
	BITFIELD_FIELD(unsigned short opcode : 5,
	BITFIELD_FIELD(unsigned short x : 1,
	BITFIELD_FIELD(unsigned short imm20_16 : 5,
	BITFIELD_FIELD(signed short imm25_21 : 5,
	;))))
};

struct m16e_i64 {
	BITFIELD_FIELD(unsigned short opcode : 5,
	BITFIELD_FIELD(unsigned short func : 3,
	BITFIELD_FIELD(unsigned short imm : 8,
	;)))
};
...
struct m16e_ri64 {
	BITFIELD_FIELD(unsigned short opcode : 5,
	BITFIELD_FIELD(unsigned short func : 3,
	BITFIELD_FIELD(unsigned short ry : 3,
	BITFIELD_FIELD(unsigned short imm : 5,
	;))))
};

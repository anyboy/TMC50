...
#elif defined CONFIG_TRACING_BACKEND_HEXDUMP
#define TRACING_BACKEND_NAME "tracing_backend_hexdump"
#elif defined CONFIG_TRACING_BACKEND_SPI
#define TRACING_BACKEND_NAME "tracing_backend_spi"
#else
...
struct _k_thread_stack_element ___in_section(tracing, stack, noinit) __aligned(STACK_ALIGN) \
	tracing_thread_stack[CONFIG_TRACING_THREAD_STACK_SIZE];

...
enum {
	BT_RFCOMM_MSC_IDLE = 0x0,
	BT_RFCOMM_MSC_CMD = 0x1,
	BT_RFCOMM_MSC_RESP = 0x2,
	BT_RFCOMM_MSC_CMDRESP = (BT_RFCOMM_MSC_CMD | BT_RFCOMM_MSC_RESP),
	BT_RFCOMM_MSC_FINISH = 0x4,
	BT_RFCOMM_MSC_MASK = (BT_RFCOMM_MSC_CMD | BT_RFCOMM_MSC_RESP | BT_RFCOMM_MSC_FINISH),
};

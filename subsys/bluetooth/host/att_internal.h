...
#define BT_ATT_MTU	min(min(BT_L2CAP_RX_MTU, CONFIG_BT_L2CAP_TX_MTU), BT_LE_DATA_EXTENSION_LEN_MTU)
#else
#define BT_ATT_MTU	min(BT_L2CAP_RX_MTU, CONFIG_BT_L2CAP_TX_MTU)
#endif

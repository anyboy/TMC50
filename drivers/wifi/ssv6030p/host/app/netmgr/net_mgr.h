...
typedef enum e_netmgr_msg
{
    ...
    MSG_JOIN_OTHER_REQ,
    MSG_JOIN_FAST_REQ, // when station mode and connect ok, if dhcpc flag is 1, netmgr will start dhcpc enable, or do nothing.
    MSG_LEAVE_REQ,
    MSG_CONTROL_REQ,
    MSG_SWITCH_REQ,
...
#endif
extern bool netmgr_check_wifi_connected();
...
int netmgr_get_ap_join_info(int *is_joining, int *re_times);
#endif

...
#if (CONFIG_CHIP_ID==SSV6051Z || CONFIG_CHIP_ID==SSV6030P || CONFIG_CHIP_ID==SSV8031B)
    #define SSV_IPD 1
...
#define SSV6051_PBUF_MapPkttoID(_PKT)		(((u32)_PKT&0x0FFF0000)>>SSV6051_PBUF_ADDR_SHIFT)

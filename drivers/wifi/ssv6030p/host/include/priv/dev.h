...
struct Host_cfg {     
    ...
    u32 app_kick_timeout:8;  
    u32 high_tmpt:8;
    u32 low_tmpt:8;

    //9th
    u32 ampdu_tx_maintry:8;
    u32 ampdu_tx_maxretry:8;
    u32 ampdu_tx_lastretryb:1;
    u32 ampdu_tx_lastbrate:2;
    u32 ampdu_tx_lastbonce:1;    
    u32 iw_src_tx_qidx1:4;    
    u32 iw_src_tx_qidx2:4;
    u32 RSVD1:4;
...
#define RX_AGG_RX_BA_MAX_SESSIONS				1 // 8

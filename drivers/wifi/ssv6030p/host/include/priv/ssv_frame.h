...
#define os_frame_alloc_timeout(_size,SecPool,timeout) os_frame_alloc_fn_timeout(_size, SecPool, timeout, __FILE__, __LINE__)
...
#define OS_FRAME_SET_HDR_OFFSET(_frame, _offset)	os_frame_set_hdr_offset(_frame, _offset)
#define OS_FRAME_GET_HDR_OFFSET(_frame)			os_frame_get_hdr_offset(_frame)

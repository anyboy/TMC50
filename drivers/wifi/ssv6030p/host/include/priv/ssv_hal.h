...
#if((CONFIG_CHIP_ID==SSV6030P)||(CONFIG_CHIP_ID==SSV6051Z)||(CONFIG_CHIP_ID==SSV6052Q) || (CONFIG_CHIP_ID==SSV8031B))
...
#elif(CONFIG_CHIP_ID==SSV6006)

#ifdef _PORTING_C_
#include <hal/SSV6006/firmware/ssv6006_uart_bin.h>
...
extern int ssv_hal_get_temperature(u8 *sar_code, s8 *temerpature);
...
return value:
    ...
    -1: Fail
*/
extern int ssv_hal_set_gpio_output(bool hi_lo, u32 pin);
/*

...
#define vTaskSuspendAll() _sched_lock()
#define xTaskResumeAll() k_sched_unlock()
...
#define HEAP_5_POOL_SIZE  16384//32768
static char heap_5_pool[HEAP_5_POOL_SIZE];

static HeapRegion_t xHeapRegions[2];

void vPortInit()
{
    xHeapRegions[0].pucStartAddress = heap_5_pool;
    xHeapRegions[0].xSizeInBytes = HEAP_5_POOL_SIZE;

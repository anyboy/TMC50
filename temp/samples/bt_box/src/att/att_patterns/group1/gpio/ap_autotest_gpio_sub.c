...
int test_gpio_short(u32_t reg_val_A, u32_t reg_val_B, u32_t io_ctrl, u8_t *index)
{
    ...
    k_busy_wait(1000);
	printk("0xc0090030 gpio12_ctl 0x%x \n",sys_read32(0xc0090030));
	printk("0xc0090100 data 0x%x \n",sys_read32(0xc0090100));
	sys_write32(sys_read32(0xc0090100) | (1 << 12), 0xc0090100);
	printk("0xc0090100 data11 0x%x \n",sys_read32(0xc0090100));
    //gpio[0~63]

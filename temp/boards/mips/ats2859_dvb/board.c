...
static const struct acts_pin_config board_pin_config[] = {
	...
	{5, 4 | GPIO_CTL_SMIT | GPIO_CTL_PADDRV_LEVEL(5)},	/* SPI0_SS */
	{6, 4 | GPIO_CTL_SMIT | GPIO_CTL_PADDRV_LEVEL(5)},	/* SPI0_SCLK */
	{9, 4 | GPIO_CTL_SMIT | GPIO_CTL_PADDRV_LEVEL(5)},	/* SPI0_MISO */
	{8, 4 | GPIO_CTL_SMIT | GPIO_CTL_PADDRV_LEVEL(5)},	/* SPI0_MOSI */
...
#if (CONFIG_UART_ACTS_PORT_1 == 1)
	/* use uart1 for UART_OTA test */
	{14, 0x7 | GPIO_CTL_SMIT | GPIO_CTL_PADDRV_LEVEL(3) | GPIO_CTL_PULLUP},	/* UART1_RX */
	{15, 0x7 | GPIO_CTL_SMIT | GPIO_CTL_PADDRV_LEVEL(3) | GPIO_CTL_PULLUP},	/* UART1_TX */
#endif
...
#endif
#elif defined(CONFIG_AUDIO_IN_I2SRX0_SUPPORT) /* i2s rx0 */
	{14,  0x9 | GPIO_CTL_SMIT | GPIO_CTL_PADDRV_LEVEL(4)},  /* I2SRX_BCLK */
	{15,  0x9 | GPIO_CTL_SMIT | GPIO_CTL_PADDRV_LEVEL(4)},  /* I2SRX_LRCLK */
	{16,  0x9 | GPIO_CTL_SMIT | GPIO_CTL_PADDRV_LEVEL(4)},  /* I2SRX_MCLK */
	{28,  0x9 | GPIO_CTL_SMIT | GPIO_CTL_PADDRV_LEVEL(4)},  /* I2SRX_DIN */
#endif
	...
	{26, 0x3 | GPIO_CTL_SMIT | GPIO_CTL_PADDRV_LEVEL(3)},
	...
	{26, 0x2 | GPIO_CTL_SMIT | GPIO_CTL_PADDRV_LEVEL(3)},
#endif

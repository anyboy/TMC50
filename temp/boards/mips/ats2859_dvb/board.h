...
#define BOARD_USB_HOST_VBUS_EN_GPIO		27	/* Vbus power en gpio for USB host */
...
#define BOARD_UART_0_TX_PIN				(14)
#define BOARD_UART_0_RX_PIN				(13)

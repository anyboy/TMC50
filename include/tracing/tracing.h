...
#elif defined CONFIG_TRACING_ATRACE
#include <tracing/atrace/tracing_os.h>
#include <tracing/atrace/tracing_media.h>
#else
 ...
 * @param thread Thread structure
 */
#define sys_trace_thread_name_set(thread, name)
...
/**
 * @brief Called when exiting an ISR to scheduler
 */
#define sys_trace_isr_exit_to_sched()

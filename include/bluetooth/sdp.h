...
#define BT_SDP_ATTR_HID_MAX_LATENCY             0x020f
#define BT_SDP_ATTR_HID_MIN_LATENCY             0x0210
...
struct bt_sdp_record {
	...
	u16_t                    attr_count; /* Number of attributes */
...
#define BT_SDP_ARRAY_8_CONST(...) ((const u8_t[]) {__VA_ARGS__})
...
#define BT_SDP_ARRAY_16_CONST(...) ((const u16_t[]) {__VA_ARGS__})

/** @def BT_SDP_ARRAY_32
 *  @brief Declare an array of 32-bit elements in an attribute.
 */
#define BT_SDP_ARRAY_32(...) ((u32_t[]) {__VA_ARGS__})
#define BT_SDP_ARRAY_32_CONST(...) ((const u32_t[]) {__VA_ARGS__})
...
#define BT_SDP_DATA_ELEM_LIST_CONST(...) ((const struct bt_sdp_data_elem[]) {__VA_ARGS__})
...
#define BT_SDP_NEW_RECORD_HANDLE \
{ \
	BT_SDP_ATTR_RECORD_HANDLE, \
	{ BT_SDP_TYPE_SIZE(BT_SDP_UINT32), BT_SDP_ARRAY_32(0) } \
}
...
{ \
	.attrs = (struct bt_sdp_attribute *)_attrs, \

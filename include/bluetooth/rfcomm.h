...
struct bt_rfcomm_server {
	 ...
	 */
	int (*accept)(struct bt_conn *conn, struct bt_rfcomm_dlc **dlc, u8_t channel);
 ...
 */
u8_t bt_rfcomm_malloc_reg_channel(void);

/** @brief free register rfcomm server channel,
 *
 *  @param channel.
 */
void bt_rfcomm_free_reg_channel(u8_t channel);

...
/* Just for rx/tx avdtp packet larger than L2CAP_BR_DEFAULT_MTU */
#define L2CAP_BR_MAX_MTU_A2DP_AAC	895
#if (CONFIG_BT_L2CAP_TX_MTU > L2CAP_BR_MAX_MTU_A2DP_AAC)
#define L2CAP_BR_MAX_MTU_A2DP	CONFIG_BT_L2CAP_TX_MTU
#else
#define L2CAP_BR_MAX_MTU_A2DP	L2CAP_BR_MAX_MTU_A2DP_AAC
#endif

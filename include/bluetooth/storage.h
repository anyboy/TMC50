...
enum {
	...
	/* Call back to user to store link key */
	BT_STORAGE_NOTIFY_LINK_KEY,

	/* Call back to user to get link key */
	BT_STORAGE_REQ_LINK_KEY,

	/* Call back to user to get bluetooth name */
	BT_STORAGE_BT_NAME,

	/* User store link key */
	BT_STORAGE_USER_LINK_KEY,
};

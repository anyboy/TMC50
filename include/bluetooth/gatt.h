...
#else
#define bt_gatt_attr_read_service NULL
#endif
...
#else
#define bt_gatt_attr_read_chrc NULL
#endif
...
#define BT_GATT_CCC_MAX ((CONFIG_BT_MAX_PAIRED - CONFIG_BT_MAX_BR_PAIRED) \
						+ (CONFIG_BT_MAX_CONN - CONFIG_BT_MAX_BR_CONN))
...
ssize_t bt_gatt_attr_read_ccc(struct bt_conn *conn,
			      ...
			      u16_t len, u16_t offset);
#else
#define bt_gatt_attr_read_ccc NULL
#endif
...
#else
#define bt_gatt_attr_write_ccc NULL
#endif

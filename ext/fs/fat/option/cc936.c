...
#if (!_USE_LFN && !_USE_CC936) || _CODE_PAGE != 936
#error This file is not needed in current configuration. Remove from the project.
#endif

#ifndef CONFIG_CODE_TABLE_IN_SDFS
static
const WCHAR uni2oem[] = {
...
#else
static WCHAR *oem2uni = 0;
static WCHAR *uni2oem = 0;
#endif
...
)
{
	...
	if (chr < 0x80) {	/* ASCII */
		...
		if (dir) {		/* OEM code to unicode */
			/* not used oem2uni, for reduce code */
		#ifdef CONFIG_CODE_TABLE_IN_SDFS
			if(!oem2uni) {
				if(sd_fmap("oem2uni.bin",(void**)&oem2uni, NULL)) {
					//printk("oem2uni bin not find \n");
					return -1;
				}
			}
		#endif
		...
		#ifdef CONFIG_CODE_TABLE_IN_SDFS
			if(!uni2oem) {
				if(sd_fmap("uni2oem.bin",(void**)&uni2oem, NULL)) {
					//printk("uni2oem bin not find \n");
					return -1;
				}
			}
		#endif

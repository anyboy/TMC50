/* -------------------------------------------------------------------------------- */
/* -- uGUI - Generic GUI module (C)Achim Dobler, 2015                            -- */
/* -------------------------------------------------------------------------------- */
// uGUI is a generic GUI module for embedded systems.
// This is a free software that is open for education, research and commercial
// developments under license policy of following terms.
//
//  Copyright (C) 2015, Achim Dobler, all rights reserved.
...
#define  USE_FONT_ZH_YAHEI_16X16
...
typedef struct
{
   ...
   extern const UG_FONT FONT_ZH_YAHEI_16X16;
#endif
...
/* Supported drivers */
#define NUMBER_OF_DRIVERS                             6
#define DRIVER_DRAW_LINE                              0
#define DRIVER_FILL_FRAME                             1
#define DRIVER_DRAW_FRAME                             2
#define DRIVER_DISP_UPDATE                            3
#define DRIVER_REGIST_CS_FUNC                         4
#define DRIVER_DRAW_CHAR							5
...
void UG_RegistCsfunc( spi_cs_func func );
int UG_DrawChar(UG_S16 x, UG_S16 y, UG_COLOR fc, UG_COLOR bc, UG_S16 charheight, UG_CharBitmap charBitmap);
